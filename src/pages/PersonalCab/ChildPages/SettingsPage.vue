        ...
        <div class="settings">
            <div>
                ...
                <div class="form_border">
                    <form>
                        <input type="text" ref="name" id="name" v-model="name" placeholder="Иван" name="user_name" :disabled="!nameEdit">
                    ...
                    <form>
                        <input type="text" ref="lastName" id="lastName" v-model="lastName" placeholder="Иванов" lastName="user_lastName" :disabled="!lastNameEdit">
                    ...
                    <form>
                        <input type="text" ref="patronymic" id="patronymic" v-model="patronymic" placeholder="Иванович" patronymic="user_patronymic" :disabled="!patronymicEdit">
